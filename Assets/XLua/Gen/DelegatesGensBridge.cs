...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(Delegate_Void_Void))
			{
			    return new Delegate_Void_Void(__Gen_Delegate_Imp0);
			}
		    ...
		    if (type == typeof(Delegate_LuaTable_String))
			{
			    return new Delegate_LuaTable_String(__Gen_Delegate_Imp1);
			}
		
		    if (type == typeof(Delegate_Void_Float))
			{
			    return new Delegate_Void_Float(__Gen_Delegate_Imp2);
			}
